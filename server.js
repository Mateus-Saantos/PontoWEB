...
app.get('/cadUsuario', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'cadastroDeUsuario.html'));
});
...
const serviceAccount = require('./config/teste2ds-2d11b-firebase-adminsdk-sqok5-054d0d7eee.json');
